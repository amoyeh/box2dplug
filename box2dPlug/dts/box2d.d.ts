declare module box2d {
    ...
    export class b2Vec2 {
        ...
        SelfRotateAngle(radian: number): b2Vec2;
        IsValid(): boolean;
    ...
    export class b2PolygonShape extends b2Shape {
        ...
        Clone(): b2Shape;
        Copy(other: b2Shape): b2Shape;
        SetAsBox(hx: number, hy: number, center?: box2d.b2Vec2, angle?: number): b2PolygonShape;
        Set(vertices: box2d.b2Vec2[]): b2PolygonShape;
        GetChildCount(): number;
        TestPoint(transform: b2Transform, p: b2Vec2): boolean;
        RayCast(output: b2RayCastOutput, input: b2RayCastInput, xf: b2Transform, childIndex: number): boolean;
        ComputeAABB(aabb: b2AABB, xf: b2Transform, childIndex: number): void;
    ...
    export class b2BuoyancyController {
        public AddBody(body: box2d.b2Body): void;
        public RemoveBody(body: box2d.b2Body): void;
        public Clear(): void;
        public m_world: box2d.b2World;
        public normal: box2d.b2Vec2;
    ...
    export class DebugDraw extends b2Draw {
        ...
        public overCtx: CanvasRenderingContext2D;
        public fillShape: boolean;
        public drawShape: boolean;
        public clearOverCanvas(): void;
        public drawOverLine(x1: number, y1: number, x2: number, y2: number, lineWidth?: number, color?: string): void;
        public drawOverCircle(x: number, y: number, radius: number, lineWidth?: number, color?: string): void;
        public drawOverRect(x: number, y: number, w: number, h: number, lineWidth?: number, color?: string): void;
        public drawBuoyancy(buoyancyControl: box2d.b2BuoyancyController, lineWidth?: number, color?: string): void;
        public drawOverTxt(x: number, y: number, text: any, align?: string, fontSize?: number, color?: string): void;
    }


    //The default distance between particles, multiplied by the particle diameter.
    export var b2_particleStride: number;
    //The minimum particle weight that produces pressure.
    export var b2_minParticleWeight: number;
    //The upper limit for particle pressure. 
    export var b2_maxParticlePressure: number;
    //The upper limit for force between particles. 
    export var b2_maxParticleForce: number;
    // The maximum distance between particles in a triad, multiplied by the particle diameter. 
    export var b2_maxTriadDistance: number;

    export class b2ParticleSystemDef {
        public strictContactCheck: boolean;
        public density: number;
        public gravityScale: number;
        public radius: number;
        public maxCount: number;
        public pressureStrength: number;
        public dampingStrength: number;
        public elasticStrength: number;
        public springStrength: number;
        public viscousStrength: number;
        public surfaceTensionPressureStrength: number;
        public surfaceTensionNormalStrength: number;
        public repulsiveStrength: number;
        public powderStrength: number;
        public ejectionStrength: number;
        public staticPressureStrength: number;
        public staticPressureRelaxation: number;
        public staticPressureIterations: number;
        public colorMixingStrength: number;
        public destroyByAge: boolean;
        public lifetimeGranularity: number;
    }
    ...
    export class b2ParticleSystem {
        ...
        public GetFlagsBuffer(): number[];
        public SetParticleFlags(index: number, newFlags: number): void;
        public GetParticleFlags(index: number): number;
        //public GetColorBuffer(): box2d.b2Vec2[];
        public GetFixtureContactFilter(): any;
    ...
    export class b2ParticleGroupDef {
        ...
        public positionData: box2d.b2Vec2[];
    ...
    export class b2ParticleGroup {
        ...
        public SetGroupFlags(flag: number): void;
        public GetMass(): number;
        public GetInertia(): number;
        public GetCenter(): box2d.b2Vec2;
        public GetLinearVelocity(): box2d.b2Vec2;
        public GetAngularVelocity(): number;
        public GetTransform(): box2d.b2Transform;
        public GetPosition(): box2d.b2Vec2;
        public GetAngle(): number;
        public GetUserData(): any;
        public SetUserData(data: any);
        public ApplyForce(force: box2d.b2Vec2): void;
        public ApplyLinearImpulse(impulse: box2d.b2Vec2): void;
        public DestroyParticles(callDestructionListener: boolean): void;
    }

    export class b2ParticleFlag {
        public static b2_waterParticle: number;
        public static b2_zombieParticle: number;
        public static b2_wallParticle: number;
        public static b2_springParticle: number;
        public static b2_elasticParticle: number;
        public static b2_viscousParticle: number;
        public static b2_powderParticle: number;
        public static b2_tensileParticle: number;
        public static b2_colorMixingParticle: number;
        public static b2_destructionListenerParticle: number;
        public static b2_barrierParticle: number;
