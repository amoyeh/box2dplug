function CustomRenderPage() {
    ...
    //add a customer renderer derived from PixiRenderer
    var customRenderer: example.CustomRenderer = new example.CustomRenderer({
    ...
    var tcPixi: box2dp.DragControl = new box2dp.DragControl(customRenderer);
